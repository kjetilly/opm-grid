...
void check_refinedPatch_grid(const std::array<long long,3> cells_per_dim,
                             const std::array<long long,3> start_ijk,
                             const std::array<long long,3> end_ijk,
...
{
    const std::array<long long,3> patch_dim = {end_ijk[0]-start_ijk[0], end_ijk[1]-start_ijk[1], end_ijk[2]-start_ijk[2]};
    ...
    long long count_faces = (cells_per_dim[0]*patch_dim[0]*cells_per_dim[1]*patch_dim[1]*((cells_per_dim[2]*patch_dim[2])+1))// 'bottom/top faces'
    ...
    long long count_corners = ((cells_per_dim[0]*patch_dim[0])+1)*((cells_per_dim[1]*patch_dim[1])+1)*((cells_per_dim[2]*patch_dim[2])+1);
    BOOST_CHECK_EQUAL(refined_corners.size(), count_corners);

    long long count_cells = cells_per_dim[0]*patch_dim[0]*cells_per_dim[1]*patch_dim[1]*cells_per_dim[2]*patch_dim[2];
...
BOOST_AUTO_TEST_CASE(patches_share_faceB)
{
    ...
    const std::array<long long, 3> grid_dim = {4,3,3};
    coarse_grid.createCartesian(grid_dim, cell_sizes);
    const std::vector<std::array<long long,3>> cells_per_dim_vec = {{4,2,2}, {3,2,2}};
    const std::vector<std::array<long long,3>> startIJK_vec = {{0,0,0}, {1,0,0}};
    const std::vector<std::array<long long,3>> endIJK_vec = {{1,1,1}, {2,1,1}};
    const std::vector<std::string> lgr_name_vec = {"LGR1", "LGR2"};
    refinePatch_and_check(coarse_grid, cells_per_dim_vec, startIJK_vec, endIJK_vec, lgr_name_vec);
}
...
BOOST_AUTO_TEST_CASE(patches_share_Iface_with_diff_cells_per_dim)
{
    ...
    const std::array<long long, 3> grid_dim = {4,3,3};
    coarse_grid.createCartesian(grid_dim, cell_sizes);
    const std::vector<std::array<long long,3>> cells_per_dim_vec = {{4,2,5}, {3,2,2}};
    const std::vector<std::array<long long,3>> startIJK_vec = {{0,0,0}, {1,0,0}};
    const std::vector<std::array<long long,3>> endIJK_vec = {{1,1,1}, {2,1,1}};
    const std::vector<std::string> lgr_name_vec = {"LGR1", "LGR2"};
    refinePatch_and_check(coarse_grid, cells_per_dim_vec, startIJK_vec, endIJK_vec, lgr_name_vec);
...
BOOST_AUTO_TEST_CASE(patches_share_Jface_with_diff_cells_per_dim)
{
    ...
    coarse_grid.createCartesian(grid_dim, cell_sizes);
    const std::vector<std::array<long long,3>> cells_per_dim_vec = {{4,2,5}, {3,2,2}};
    const std::vector<std::array<long long,3>> startIJK_vec = {{0,0,0}, {0,1,0}};
    const std::vector<std::array<long long,3>> endIJK_vec = {{1,1,1}, {1,2,1}};
    const std::vector<std::string> lgr_name_vec = {"LGR1", "LGR2"};
    refinePatch_and_check(coarse_grid, cells_per_dim_vec, startIJK_vec, endIJK_vec, lgr_name_vec);
}
...
BOOST_AUTO_TEST_CASE(patches_share_Kface_with_diff_cells_per_dim)
{
    ...
    coarse_grid.createCartesian(grid_dim, cell_sizes);
    const std::vector<std::array<long long,3>> cells_per_dim_vec = {{4,2,5}, {3,2,2}};
    const std::vector<std::array<long long,3>> startIJK_vec = {{0,0,0}, {0,0,1}};
    const std::vector<std::array<long long,3>> endIJK_vec = {{1,1,1}, {1,1,2}};
    const std::vector<std::string> lgr_name_vec = {"LGR1", "LGR2"};
    refinePatch_and_check(coarse_grid, cells_per_dim_vec, startIJK_vec, endIJK_vec, lgr_name_vec);
}
...
BOOST_AUTO_TEST_CASE(global_refine)
{
    ...
    const std::array<long long, 3> fine_grid_dim = {8,6,6};
...
BOOST_AUTO_TEST_CASE(global_norefine)
{
    ...
    const std::array<double, 3> cell_sizes = {1.0, 1.0, 1.0};
    const std::array<long long, 3> grid_dim = {4,3,3};
    const std::array<long long, 3> cells_per_dim = {1,1,1};
    const std::array<long long, 3> startIJK = {0,0,0};
    const std::array<long long, 3> endIJK = {4,3,3};
    const std::string lgr_name = "LGR";
    coarse_grid.createCartesian(grid_dim, cell_sizes);
    ...
    const std::array<long long, 3> fine_grid_dim = {4,3,3};
    fine_grid.createCartesian(fine_grid_dim, fine_cell_sizes);
